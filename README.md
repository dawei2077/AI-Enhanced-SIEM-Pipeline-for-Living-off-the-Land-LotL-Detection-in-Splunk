...
*Figure 1: Data flow architecture from log generation to AI threat triage.*
...
*Figure 2: Real-time detection with automated analysis generated by the Gemini API.*
